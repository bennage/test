...
debugOutputFolder = get_key(envPath, "DEBUG_OUTPUT_FOLDER")
...
lvaExtensionPath = get_key(envPath, "AVA_EXTENSION_PATH")
userName = get_key(envPath, "USERNAME")
lvaSamplePath = get_key(envPath, "AVA_SAMPLE_PATH")
topologyFile = get_key(envPath, "TOPOLOGY_FILE")
graphInstanceName = get_key(envPath, "GRAPH_INSTANCE_NAME")
topologyName = get_key(envPath, "TOPOLOGY_NAME")
vm_type = get_key(envPath, "VM_TYPE")