# AVA ResNet50 iCPU ONNX Sample on Jupyter Notebooks 
...
We provide several notebooks and documents that help in running the ResNet50 ONNX model on Live Video Analytics:
